...
| 8pm every other Sunday | First attempt at lab assignments begun the previous Wednesday will be due. You will get one second attempt at each individual lab. If you turn in your lab late, then only get one attempt. (Group labs do not get multiple attempts) |
...
If you need to miss class or reschedule a final examination due to a religious observance, please speak to the professor well in advance 
