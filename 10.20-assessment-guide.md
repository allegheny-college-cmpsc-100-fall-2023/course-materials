# Study Guide for Timed Assessment on October 20
...
The test is designed so that you can complete it during the exam period, but you have until the end of the day in case of technical difficulties. I will be available on Discord and in the classroom to answer questions about the test until 10:50 AM. I may not be available to answer questions after that. 

The test will include opportunities to get credit for **variables**, **math and logic**, **while-loops**, **for-loops**, **lists** and **if-else**. 

You can take the test wherever you want. It is up to you whether you'd like to come to the classroom to take the test.
...
-[Video Demo](https://drive.google.com/file/d/1huEYVw9bLxFnmsTm_-HbiQRcXqmIeaK_/view?usp=drive_link)
